...
def init(app: FastMCP, session: Session) -> None:
    """Initialize Tiles tools with the FastMCP application."""
    ...
    async def get_scene_thumbnail(
        ...
        """
        thumbnail = f"https://tiles.planet.com/data/v1/item-types/{item_type}/items/{item_id}/thumb"
